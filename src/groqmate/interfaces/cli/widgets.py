...
class CustomFooter(Container):
    ...
    CustomFooter .separator {
        color: #333333;
        margin: 0 1;
    }
    
    CustomFooter .binding {
        color: #666666;
    }
    ...
    def compose(self):
        yield Static(
            f"[bold #ff6b35]groqmate[/] [#333333]│[/] [#666666][#00ff88]Ctrl+P[/] Settings [#333333]│[/] [#00ff88]Ctrl+L[/] Clear [#333333]│[/] [#00ff88]Ctrl+Q[/] Quit[/]",
            id="footer-content",
        )
